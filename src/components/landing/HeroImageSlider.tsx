...
const MORPH_TRANSITION_DURATION = 1400; // 1400ms smooth cinematic morph dissolve (cubic-bezier(0.22, 1, 0.36, 1))
...
export default function HeroImageSlider({ language: propLanguage }: HeroImageSliderProps = {}) {
  ...
  return (
    <div className={styles.sliderWrapper}>
      ...
      <div
        id="noormexa-slider-frame"
        className={`${styles.imageScreen} noormexa-slider-frame`}
